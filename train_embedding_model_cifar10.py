...
if __name__ == '__main__':
    ...
    parser.add_argument("--cfg", default="./config/embedding_cifar10.yaml", type=str, help="config file path")
    ...
    train_dataset = torchvision.datasets.CIFAR10(root="./datasets", train=True, transform=train_transforms,
                                                 download=True)
