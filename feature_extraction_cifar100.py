...
if __name__ == '__main__':
    ...
    for data, cls_idx in val_data_loader:
        ...
        if cls_idx in feature_data and len(feature_data[cls_idx]) == 10 or \
                (cls_idx not in feature_data and len(feature_data) >= 50):
            continue
...
plt.savefig("./results/plot_cifar100_no_value.jpg")
plt.show()
